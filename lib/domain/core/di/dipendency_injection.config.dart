...
import 'package:bechdu_partner/data/service/requote/requote_service.dart'
    as _i17;
import 'package:bechdu_partner/domain/core/dio_module/dio_module.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i18.PickupPartnerBloc>(
        () => _i18.PickupPartnerBloc(gh<_i12.PickupPartnerRepo>()));
    gh.factory<_i19.PointsBloc>(() => _i19.PointsBloc(gh<_i14.PointsRepo>()));
    gh.factory<_i20.RequoteBloc>(
        () => _i20.RequoteBloc(gh<_i16.RequoteRepo>()));
    return this;
  }
}
